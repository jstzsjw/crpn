...
#define __PYX_HAVE__quad__quad_2_obb
#define __PYX_HAVE_API__quad__quad_2_obb
#include <string.h>
#include <stdio.h>
#include <stdlib.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "Quad2Obb.hpp"
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'quad.quad_2_obb' */
static __Pyx_TypeInfo __Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t = { "float32_t", NULL, sizeof(__pyx_t_5numpy_float32_t), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "quad.quad_2_obb"
int __pyx_module_is_main_quad__quad_2_obb = 0;

/* Implementation of 'quad.quad_2_obb' */
...
static const char __pyx_k_tmps[] = "tmps";
...
static const char __pyx_k_nquads[] = "nquads";
static const char __pyx_k_float32[] = "float32";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_quad_2_obb[] = "quad_2_obb";
static const char __pyx_k_ImportError[] = "ImportError";
static const char __pyx_k_RuntimeError[] = "RuntimeError";
static const char __pyx_k_quad_quad_2_obb[] = "quad.quad_2_obb";
static const char __pyx_k_ndarray_is_not_C_contiguous[] = "ndarray is not C contiguous";
static const char __pyx_k_home_xhdeng_crpn_lib_quad_quad[] = "/home/xhdeng/crpn/lib/quad/quad_2_obb.pyx";
...
static PyObject *__pyx_kp_s_home_xhdeng_crpn_lib_quad_quad;
...
static PyObject *__pyx_n_s_nquads;
static PyObject *__pyx_n_s_numpy;
static PyObject *__pyx_kp_s_numpy_core_multiarray_failed_to;
static PyObject *__pyx_kp_s_numpy_core_umath_failed_to_impor;
static PyObject *__pyx_n_s_qd;
static PyObject *__pyx_n_s_quad_2_obb;
static PyObject *__pyx_n_s_quad_quad_2_obb;
...
static PyObject *__pyx_pf_4quad_10quad_2_obb_quad_2_obb(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_quads); /* proto */
...
/* Python wrapper */
static PyObject *__pyx_pw_4quad_10quad_2_obb_1quad_2_obb(PyObject *__pyx_self, PyObject *__pyx_v_quads); /*proto*/
static PyMethodDef __pyx_mdef_4quad_10quad_2_obb_1quad_2_obb = {"quad_2_obb", (PyCFunction)__pyx_pw_4quad_10quad_2_obb_1quad_2_obb, METH_O, 0};
static PyObject *__pyx_pw_4quad_10quad_2_obb_1quad_2_obb(PyObject *__pyx_self, PyObject *__pyx_v_quads) {
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("quad_2_obb (wrapper)", 0);
  if (unlikely(!__Pyx_ArgTypeTest(((PyObject *)__pyx_v_quads), __pyx_ptype_5numpy_ndarray, 1, "quads", 0))) __PYX_ERR(0, 7, __pyx_L1_error)
  __pyx_r = __pyx_pf_4quad_10quad_2_obb_quad_2_obb(__pyx_self, ((PyArrayObject *)__pyx_v_quads));
...
static PyObject *__pyx_pf_4quad_10quad_2_obb_quad_2_obb(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_quads) {
  int __pyx_v_nquads;
  PyArrayObject *__pyx_v_qd = 0;
  PyArrayObject *__pyx_v_tmp = 0;
  PyArrayObject *__pyx_v_tmps = 0;
  int __pyx_v__i;
  __Pyx_LocalBuf_ND __pyx_pybuffernd_qd;
  __Pyx_Buffer __pyx_pybuffer_qd;
  ...
  __Pyx_RefNannySetupContext("quad_2_obb", 0);
  __pyx_pybuffer_qd.pybuffer.buf = NULL;
  __pyx_pybuffer_qd.refcount = 0;
  __pyx_pybuffernd_qd.data = NULL;
  __pyx_pybuffernd_qd.rcbuffer = &__pyx_pybuffer_qd;
  ...
  __pyx_pybuffernd_quads.rcbuffer = &__pyx_pybuffer_quads;
  {
    ...
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_quads.rcbuffer->pybuffer, (PyObject*)__pyx_v_quads, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) __PYX_ERR(0, 7, __pyx_L1_error)
  }
  __pyx_pybuffernd_quads.diminfo[0].strides = __pyx_pybuffernd_quads.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_quads.diminfo[0].shape = __pyx_pybuffernd_quads.rcbuffer->pybuffer.shape[0]; __pyx_pybuffernd_quads.diminfo[1].strides = __pyx_pybuffernd_quads.rcbuffer->pybuffer.strides[1]; __pyx_pybuffernd_quads.diminfo[1].shape = __pyx_pybuffernd_quads.rcbuffer->pybuffer.shape[1];

  /* "quad/quad_2_obb.pyx":8
 * 
 * def quad_2_obb(np.ndarray[np.float32_t, ndim=2] quads):
 *     cdef int nquads = quads.shape[0]             # <<<<<<<<<<<<<<
 *     if nquads == 0:
 *         return quads
 */
  __pyx_v_nquads = (__pyx_v_quads->dimensions[0]);

  /* "quad/quad_2_obb.pyx":9
 * def quad_2_obb(np.ndarray[np.float32_t, ndim=2] quads):
 *     cdef int nquads = quads.shape[0]
 *     if nquads == 0:             # <<<<<<<<<<<<<<
 *         return quads
 ...
 */
  __pyx_t_1 = ((__pyx_v_nquads == 0) != 0);
  if (__pyx_t_1) {

    /* "quad/quad_2_obb.pyx":10
 *     cdef int nquads = quads.shape[0]
 *     if nquads == 0:
 *         return quads             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=1] qd = np.zeros(8, dtype=np.float32)
 ...
 */
    ...
    __Pyx_INCREF(((PyObject *)__pyx_v_quads));
    __pyx_r = ((PyObject *)__pyx_v_quads);
    goto __pyx_L0;
 ...
 */
  ...
  __pyx_t_5 = __Pyx_PyObject_Call(__pyx_t_3, __pyx_tuple_, __pyx_t_2); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 11, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_qd.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      __pyx_v_qd = ((PyArrayObject *)Py_None); __Pyx_INCREF(Py_None); __pyx_pybuffernd_qd.rcbuffer->pybuffer.buf = NULL;
      __PYX_ERR(0, 11, __pyx_L1_error)
    } else {__pyx_pybuffernd_qd.diminfo[0].strides = __pyx_pybuffernd_qd.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_qd.diminfo[0].shape = __pyx_pybuffernd_qd.rcbuffer->pybuffer.shape[0];
    }
  }
  __pyx_t_6 = 0;
  __pyx_v_qd = ((PyArrayObject *)__pyx_t_5);
  __pyx_t_5 = 0;

  /* "quad/quad_2_obb.pyx":12
 *         return quads
 *     cdef np.ndarray[np.float32_t, ndim=1] qd = np.zeros(8, dtype=np.float32)
 *     cdef np.ndarray[np.float32_t, ndim=1] tmp = np.zeros(5, dtype=np.float32)             # <<<<<<<<<<<<<<
 *     cdef np.ndarray[np.float32_t, ndim=2] tmps = np.zeros((nquads, 5), dtype=np.float32)
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_zeros); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_2, __pyx_tuple__2, __pyx_t_5); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 12, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_tmp.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
 ...
 */
  ...
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_zeros); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = __Pyx_PyInt_From_int(__pyx_v_nquads); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  ...
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_8 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_float32); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  if (PyDict_SetItem(__pyx_t_2, __pyx_n_s_dtype, __pyx_t_8) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_8); __pyx_t_8 = 0;
  __pyx_t_8 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_4, __pyx_t_2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_8);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  ...
  {
    __Pyx_BufFmt_StackElem __pyx_stack[1];
    if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_tmps.rcbuffer->pybuffer, (PyObject*)__pyx_t_9, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 2, 0, __pyx_stack) == -1)) {
  ...
  __pyx_t_9 = 0;
  __pyx_v_tmps = ((PyArrayObject *)__pyx_t_8);
  __pyx_t_8 = 0;

  /* "quad/quad_2_obb.pyx":15
 *     cdef np.ndarray[np.float32_t, ndim=2] tmps = np.zeros((nquads, 5), dtype=np.float32)
 *     cdef int _i
 *     for _i in range(nquads):             # <<<<<<<<<<<<<<
 *         qd = quads[_i, :]
 *         tmp = tmps[_i, :]
 */
  __pyx_t_10 = __pyx_v_nquads;
  for (__pyx_t_11 = 0; __pyx_t_11 < __pyx_t_10; __pyx_t_11+=1) {
    __pyx_v__i = __pyx_t_11;

    /* "quad/quad_2_obb.pyx":16
 *     cdef int _i
 *     for _i in range(nquads):
 *         qd = quads[_i, :]             # <<<<<<<<<<<<<<
 *         tmp = tmps[_i, :]
 *         Quad2Obb(&qd[0], &tmp[0])
 */
    __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v__i); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 16, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    ...
    __pyx_t_8 = 0;
    __pyx_t_8 = PyObject_GetItem(((PyObject *)__pyx_v_quads), __pyx_t_2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 16, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_qd.rcbuffer->pybuffer);
      __pyx_t_12 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_qd.rcbuffer->pybuffer, (PyObject*)__pyx_t_6, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_12 < 0)) {
        PyErr_Fetch(&__pyx_t_13, &__pyx_t_14, &__pyx_t_15);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_qd.rcbuffer->pybuffer, (PyObject*)__pyx_v_qd, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
      ...
      __pyx_pybuffernd_qd.diminfo[0].strides = __pyx_pybuffernd_qd.rcbuffer->pybuffer.strides[0]; __pyx_pybuffernd_qd.diminfo[0].shape = __pyx_pybuffernd_qd.rcbuffer->pybuffer.shape[0];
      if (unlikely(__pyx_t_12 < 0)) __PYX_ERR(0, 16, __pyx_L1_error)
    }
    __pyx_t_6 = 0;
    __Pyx_DECREF_SET(__pyx_v_qd, ((PyArrayObject *)__pyx_t_8));
    __pyx_t_8 = 0;

    /* "quad/quad_2_obb.pyx":17
 *     for _i in range(nquads):
 *         qd = quads[_i, :]
 *         tmp = tmps[_i, :]             # <<<<<<<<<<<<<<
 *         Quad2Obb(&qd[0], &tmp[0])
 *     return tmps
 */
    __pyx_t_8 = __Pyx_PyInt_From_int(__pyx_v__i); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    ...
    __pyx_t_8 = 0;
    __pyx_t_8 = PyObject_GetItem(((PyObject *)__pyx_v_tmps), __pyx_t_2); if (unlikely(!__pyx_t_8)) __PYX_ERR(0, 17, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_8);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    if (!(likely(((__pyx_t_8) == Py_None) || likely(__Pyx_TypeTest(__pyx_t_8, __pyx_ptype_5numpy_ndarray))))) __PYX_ERR(0, 17, __pyx_L1_error)
    __pyx_t_7 = ((PyArrayObject *)__pyx_t_8);
    {
      __Pyx_BufFmt_StackElem __pyx_stack[1];
      __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_tmp.rcbuffer->pybuffer);
      __pyx_t_12 = __Pyx_GetBufferAndValidate(&__pyx_pybuffernd_tmp.rcbuffer->pybuffer, (PyObject*)__pyx_t_7, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack);
      if (unlikely(__pyx_t_12 < 0)) {
        PyErr_Fetch(&__pyx_t_15, &__pyx_t_14, &__pyx_t_13);
        if (unlikely(__Pyx_GetBufferAndValidate(&__pyx_pybuffernd_tmp.rcbuffer->pybuffer, (PyObject*)__pyx_v_tmp, &__Pyx_TypeInfo_nn___pyx_t_5numpy_float32_t, PyBUF_FORMAT| PyBUF_STRIDES, 1, 0, __pyx_stack) == -1)) {
    ...
    __pyx_t_7 = 0;
    __Pyx_DECREF_SET(__pyx_v_tmp, ((PyArrayObject *)__pyx_t_8));
    __pyx_t_8 = 0;

    /* "quad/quad_2_obb.pyx":18
 *         qd = quads[_i, :]
 *         tmp = tmps[_i, :]
 *         Quad2Obb(&qd[0], &tmp[0])             # <<<<<<<<<<<<<<
 *     return tmps
 */
    ...
    __pyx_t_12 = -1;
    if (__pyx_t_16 < 0) {
      __pyx_t_16 += __pyx_pybuffernd_qd.diminfo[0].shape;
      if (unlikely(__pyx_t_16 < 0)) __pyx_t_12 = 0;
    } else if (unlikely(__pyx_t_16 >= __pyx_pybuffernd_qd.diminfo[0].shape)) __pyx_t_12 = 0;
    ...
    } else if (unlikely(__pyx_t_17 >= __pyx_pybuffernd_tmp.diminfo[0].shape)) __pyx_t_12 = 0;
    if (unlikely(__pyx_t_12 != -1)) {
      __Pyx_RaiseBufferIndexError(__pyx_t_12);
      __PYX_ERR(0, 18, __pyx_L1_error)
    }
    Quad2Obb((&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_qd.rcbuffer->pybuffer.buf, __pyx_t_16, __pyx_pybuffernd_qd.diminfo[0].strides))), (&(*__Pyx_BufPtrStrided1d(__pyx_t_5numpy_float32_t *, __pyx_pybuffernd_tmp.rcbuffer->pybuffer.buf, __pyx_t_17, __pyx_pybuffernd_tmp.diminfo[0].strides))));
  }

  /* "quad/quad_2_obb.pyx":19
 *         tmp = tmps[_i, :]
 *         Quad2Obb(&qd[0], &tmp[0])
 *     return tmps             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __Pyx_INCREF(((PyObject *)__pyx_v_tmps));
  __pyx_r = ((PyObject *)__pyx_v_tmps);
  goto __pyx_L0;
 ...
 */
  ...
  __Pyx_AddTraceback("quad.quad_2_obb.quad_2_obb", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = NULL;
  goto __pyx_L2;
  __pyx_L0:;
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_qd.rcbuffer->pybuffer);
  ...
  __Pyx_SafeReleaseBuffer(&__pyx_pybuffernd_tmps.rcbuffer->pybuffer);
  __pyx_L2:;
  __Pyx_XDECREF((PyObject *)__pyx_v_qd);
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_home_xhdeng_crpn_lib_quad_quad, __pyx_k_home_xhdeng_crpn_lib_quad_quad, sizeof(__pyx_k_home_xhdeng_crpn_lib_quad_quad), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_nquads, __pyx_k_nquads, sizeof(__pyx_k_nquads), 0, 0, 1, 1},
  {&__pyx_n_s_numpy, __pyx_k_numpy, sizeof(__pyx_k_numpy), 0, 0, 1, 1},
  {&__pyx_kp_s_numpy_core_multiarray_failed_to, __pyx_k_numpy_core_multiarray_failed_to, sizeof(__pyx_k_numpy_core_multiarray_failed_to), 0, 0, 1, 0},
  {&__pyx_kp_s_numpy_core_umath_failed_to_impor, __pyx_k_numpy_core_umath_failed_to_impor, sizeof(__pyx_k_numpy_core_umath_failed_to_impor), 0, 0, 1, 0},
  {&__pyx_n_s_qd, __pyx_k_qd, sizeof(__pyx_k_qd), 0, 0, 1, 1},
  {&__pyx_n_s_quad_2_obb, __pyx_k_quad_2_obb, sizeof(__pyx_k_quad_2_obb), 0, 0, 1, 1},
  {&__pyx_n_s_quad_quad_2_obb, __pyx_k_quad_quad_2_obb, sizeof(__pyx_k_quad_quad_2_obb), 0, 0, 1, 1},
 ...
 *     cdef np.ndarray[np.float32_t, ndim=2] tmps = np.zeros((nquads, 5), dtype=np.float32)
 */
  __pyx_tuple_ = PyTuple_Pack(1, __pyx_int_8); if (unlikely(!__pyx_tuple_)) __PYX_ERR(0, 11, __pyx_L1_error)
 ...
 *     cdef int _i
 */
  __pyx_tuple__2 = PyTuple_Pack(1, __pyx_int_5); if (unlikely(!__pyx_tuple__2)) __PYX_ERR(0, 12, __pyx_L1_error)
 ...
 *     return tmps
 */
  __pyx_slice__4 = PySlice_New(Py_None, Py_None, Py_None); if (unlikely(!__pyx_slice__4)) __PYX_ERR(0, 17, __pyx_L1_error)
 ...
 *     if nquads == 0:
 */
  __pyx_tuple__14 = PyTuple_Pack(6, __pyx_n_s_quads, __pyx_n_s_nquads, __pyx_n_s_qd, __pyx_n_s_tmp, __pyx_n_s_tmps, __pyx_n_s_i); if (unlikely(!__pyx_tuple__14)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__14);
  __Pyx_GIVEREF(__pyx_tuple__14);
  __pyx_codeobj__15 = (PyObject*)__Pyx_PyCode_New(1, 0, 6, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__14, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_home_xhdeng_crpn_lib_quad_quad, __pyx_n_s_quad_2_obb, 7, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__15)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initquad_2_obb(void); /*proto*/
PyMODINIT_FUNC initquad_2_obb(void)
#else
PyMODINIT_FUNC PyInit_quad_2_obb(void); /*proto*/
PyMODINIT_FUNC PyInit_quad_2_obb(void)
#endif
{
  PyObject *__pyx_t_1 = NULL;
  __Pyx_RefNannyDeclarations
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_quad_2_obb(void)", 0);
  ...
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("quad_2_obb", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_quad__quad_2_obb) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "quad.quad_2_obb")) {
      if (unlikely(PyDict_SetItemString(modules, "quad.quad_2_obb", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 *     if nquads == 0:
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_4quad_10quad_2_obb_1quad_2_obb, NULL, __pyx_n_s_quad_quad_2_obb); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_quad_2_obb, __pyx_t_1) < 0) __PYX_ERR(0, 7, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init quad.quad_2_obb", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init quad.quad_2_obb");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if PY_MAJOR_VERSION < 3
